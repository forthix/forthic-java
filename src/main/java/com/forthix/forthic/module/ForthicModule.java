...
public class ForthicModule {
    ...
    public void importModule(String prefix, ForthicModule module, BareInterpreter interp) {
        ...
        List<Word> exportableWords = newModule.exportableWords();
        for (Word word : exportableWords) {
            if (prefix.isEmpty()) {
    ...
    public void addMemoWords(Word word) {
    ...
    public void addExportableWord(Word word) {
        words.add(word);
    ...
    public List<Word> exportableWords() {
    ...
    public Word findWord(String name) {
        Word result = findDictionaryWord(name);
        if (result == null) {
    ...
    public Word findDictionaryWord(String wordName) {
